...
define dso_local zeroext i1 @_Z12hamCycleUtilPA5_bPii([5 x i8]* %graph, i32* %path, i32 %pos) #5 {
entry:
  %retval = alloca i1, align 1
  %graph.addr = alloca [5 x i8]*, align 8
  %path.addr = alloca i32*, align 8
...
; Function Attrs: noinline optnone uwtable
define dso_local zeroext i1 @_Z8hamCyclePA5_b([5 x i8]* %graph) #5 {
entry:
  %retval = alloca i1, align 1
  %graph.addr = alloca [5 x i8]*, align 8
...
; Function Attrs: noinline optnone uwtable
define dso_local void @_Z13printSolutionPi(i32* %path) #5 {
entry:
  %path.addr = alloca i32*, align 8
  %i = alloca i32, align 4
  store i32* %path, i32** %path.addr, align 8
